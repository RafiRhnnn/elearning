...
<aside id="sidebar"
    ...
    <div class="p-6 border-b border-green-400 flex flex-col items-center">
        ...
        <h1 class="text-2xl font-extrabold text-white tracking-wide">Panel Guru</h1>
        ...
        <ul class="space-y-2">
            <li>
                <a href="{{ route('guru.dashboard') }}"
                    class="flex items-center gap-3 py-2 px-4 rounded-lg transition {{ request()->routeIs('guru.dashboard') ? 'bg-white text-green-700 font-bold shadow' : 'text-white hover:bg-green-600/70' }}">
            ...
            <li>
                <a href="{{ route('guru.pengumpulan.index') }}"
                    class="flex items-center gap-3 py-2 px-4 rounded-lg transition {{ request()->routeIs('guru.pengumpulan.*') ? 'bg-white text-green-700 font-bold shadow' : 'text-white hover:bg-green-600/70' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            {{-- <li>
                <a href="{{ route('guru.absen') }}"
                    class="flex items-center gap-3 py-2 px-4 rounded-lg transition {{ request()->routeIs('guru.absen') ? 'bg-white text-green-700 font-bold shadow' : 'text-white hover:bg-green-600/70' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path
